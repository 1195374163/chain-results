...
exp_names = ["zk_strong/test"]
savedir = "graphs/"
os.makedirs(savedir, exist_ok=True)

n_threads = [2, 5, 10, 20, 30, 50, 75, 100, 150, 200, 250, 300, 350, 500, 700]
n_clients = 3
payload = 128
reads = 95
n_servers = [3, 5, 7]
...
alg_limiter = {
    "original": {3: 250, 5: 350, 7: 350},
    "chain": {3: 700, 5: 700, 7: 700}
}
alg_mapper = {
    "original_1": "Zookeeper 1 Rep",
    "chain_1": "Chain-Zookeeper 1 Rep",
    "original_3": "Zookeeper 3 Reps",
    "chain_3": "Chain-Zookeeper 3 Reps",
    "original_5": "Zookeeper 5 Rep",
    "chain_5": "Chain-Zookeeper 5 Rep",
    "original_7": "Zookeeper 7 Rep",
    "chain_7": "Chain-Zookeeper 7 Rep",
}
...
def create_plot(results_all):
    ...
    plt.legend()
    plt.savefig(savedir + "zookeeper_strong" + "_serv" + str(n_servers) + "_read" + str(reads) + ".pdf")
